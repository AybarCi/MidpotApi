...
namespace DatingWeb.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        {
            return Ok(await _userRepository.UpdateProfileSettings(this.GetUserId, model.Description, model.FromAge, model.UntilAge, model.School, model.Job, model.DeviceToken));
        }
